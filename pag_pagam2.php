...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['quant'])) {
    $produto_id = 2; // ID do produto no banco de dados
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="product-details">
                <img src="img/adubo.png"Biogás da decomposição de plástico" class="product-image">
                <h2>Adubo da Decomposição de Plástico</h2>
                <p class="product-price">R$ 1.646,22 /cada</p>
                <p class="product-description">O plástico compostável se decompõe em água, dióxido de carbono e biomassa, e, diferentemente de um plástico biodegradável, produz adubo, pois se desintegra junto a materiais orgânicos em uma usina de compostagem ou em uma composteira doméstica.</p>
            </div>
            ...
            <form method="post">
                ...
                <button type="submit" class="submit-button">Pagina Pagamento Pix</button>
            </form>
        </main>
    </div>
</body>
