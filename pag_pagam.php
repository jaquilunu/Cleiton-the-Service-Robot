...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['quant'])) {
    $produto_id = 1; // ID do produto no banco de dados
    ...
    <div class="container">
        ...
        <main class="main-content">
            <div class="product-details">
                <img src="img/Gas.png" alt="Biogás da decomposição de plástico" class="product-image">
                <h2>Biogás da Decomposição de Plástico</h2>
                <p class="product-price">R$ 1.646,22 /cada</p>
                <p class="product-description">O biogás é produzido através da decomposição de plásticos em um processo que garante energia renovável. A aplicação deste produto é ideal para indústrias que buscam reduzir a pegada ambiental.</p>
            </div>
